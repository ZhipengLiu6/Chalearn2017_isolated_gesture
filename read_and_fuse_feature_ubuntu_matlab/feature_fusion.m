function [ output_args ] = feature_fusion( trfeaturePath1, trfeaturePath2, savetrainfile, isTrain )
...
if isTrain == 1
    ...
    vafeatureDepth = load(trfeaturePath1);
    vafeatureRGB = load(trfeaturePath2);
    ...
    save(savetrainfile, 'validationfeature', 'validationlabel', 'validationVideoid', '-v7.3');
end
